...
async function handleFormSubmit(event) {
  ...
  try {
    const url = isEditMode
      ? `https://perpustakaan-production-969d.up.railway.app/api/books/${editBookId}`
      : "https://perpustakaan-production-969d.up.railway.app/api/books";
...
async function loadBooks() {
  try {
    const response = await fetch("https://perpustakaan-production-969d.up.railway.app/api/books");
...
async function loadDashboardStats() {
  try {
    const [booksRes, loansRes] = await Promise.all([
      fetch("https://perpustakaan-production-969d.up.railway.app/api/books"),
      fetch("https://perpustakaan-production-969d.up.railway.app/api/loans")
    ]);
...
async function handlePeminjamanSubmit(e) {
  ...
  try {
    const res = await fetch("https://perpustakaan-production-969d.up.railway.app/api/loans", {
      method: "POST",
...
async function konfirmasiPengembalian(id) {
  if (confirm("Yakin ingin menandai peminjaman ini sebagai sudah dikembalikan?")) {
    try {
      const response = await fetch(`https://perpustakaan-production-969d.up.railway.app/api/loans/${id}/return`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
